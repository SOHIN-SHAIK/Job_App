...
class AllJobs extends Component {
    ...
    if (responseSuccess) {
      ...
      return (
        <div className="profile-container">
          ...
          <p className="profie-description">{shortBio}</p>
        </div>
      )
    }
    return null
  ...
  renderLoadingView = () => (
    <div className="loader-container" data-testid="loader">
      <Loader type="ThreeDots" color="#0b69ff" heights="50" width="50" />
    </div>
  )
  ...
  onRenderProfileStatus = () => {
    ...
    switch (apiStatus) {
      ...
      case apiStatusConstants.failure:
        return this.onGetProfileaFailureView()
        ...
        <div className="all-jobs-container">
          ...
          <div className="jobs-container">
            <div>
              ...
              >
                <AiOutlineSearch className="seacrh-icon" />
              </button>
            </div>
